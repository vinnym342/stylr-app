...
class HashtagsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hashtag" do
    assert_difference('Hashtag.count') do
      post hashtags_url, params: { hashtag: { styleboard: @hashtag.styleboard, tag: @hashtag.tag } }
    end
  ...
  test "should update hashtag" do
    patch hashtag_url(@hashtag), params: { hashtag: { styleboard: @hashtag.styleboard, tag: @hashtag.tag } }
